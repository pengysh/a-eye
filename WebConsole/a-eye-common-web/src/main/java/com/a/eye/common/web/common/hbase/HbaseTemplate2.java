...
import com.a.eye.common.web.common.hbase.parallel.ParallelResultScanner;
import com.a.eye.common.web.common.hbase.parallel.ScanTaskException;
import com.a.eye.common.web.common.util.ExecutorFactory;
import com.a.eye.common.web.common.util.PinpointThreadFactory;
import com.a.eye.common.web.common.util.StopWatch;
...
public class HbaseTemplate2 extends HbaseTemplate implements HbaseOperations2, InitializingBean, DisposableBean {
    ...
    private static Logger logger = LogManager.getLogger(HbaseTemplate2.class);
